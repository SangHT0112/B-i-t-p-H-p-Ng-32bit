...
main proc ; Bắt đầu quá trình thực thi của chương trình
    ...
    while_loop: ; Nhãn của vòng lặp
        ...
        jle skip_update_max_digit ; Nếu chữ số dư không lớn hơn max_digit, bỏ qua việc cập nhật max_digit
        mov max_digit, edx ; Nếu chữ số dư lớn hơn max_digit, cập nhật max_digit
    ...
    invoke StdOut, addr max_digit ; In ra chữ số lớn nhất của số nguyên dương n
